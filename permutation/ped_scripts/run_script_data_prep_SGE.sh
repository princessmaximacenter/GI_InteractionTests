...
echo "module load R; Rscript ./ped_scripts/data_prep_ped.R ${inputfile} ${project} ${alttype} ${max_x} ${intv_x}" | \
qsub -l h_rt=1:00:00,tmpspace=1G,h_vmem=1G -o ${logdirstep} -e ${logdirstep} -N "J1_"${proj_name}
