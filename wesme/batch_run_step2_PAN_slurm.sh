...
{
  echo "usage:
  batch_run_step2_PAN_slurm.sh -p project -n npermut -s nsampl -m vmem -t hrs
                               -o come -f first -l last
...
logdir=./log/${project}_st2_${d}/PAN
...
-e ${logdir}/subjobs/st2_${proj_name}_PAN_${come}_\%a.e \
-o /dev/null \
-J PAN_${proj_name}_${come}_st2_ws \
./run_step2_PAN_i_slurm.sh ${project} ${nsampl} ${come} 0 | awk -F. '{print $1}')

sbatch -d $hold_jid -J PAN_${proj_name}_${come}_st2_log \
-o ${logdir}/st2_PAN_${proj_name}_${come}_${hold_jid}.o \
-e /dev/null \
